    ...
    <table class="info-table request">
        ...
        ?>
            ...
            if($delivery_mode == "DELIVERY"){
                $action_page = 'ready_for_shipping.php';
                $button_text = 'Ready for Shipping';
            }
            else if($delivery_mode == "PICK-UP"){
                $action_page = 'ready_for_pickup.php';
                $button_text = 'Ready for Pickup';
            }
            ?>
            
            <?php
                if(!empty($action_page) && isset($id)){
                    echo '<form id="action-form" method="POST" action="">';
                    echo '<input type="hidden" name="request_id" value="' . htmlspecialchars($id) . '">';
                    echo '<input type="hidden" name="action_type" value="' . $delivery_mode . '">';
                    echo '</form>';
                }
            ?>
            <div class="bottom doc-btns">

                <a href="document.php" class="back-btn">Back</a>
                    <?php
                    if(!empty($action_page) && isset($id)){
                        echo '<button type="submit" class="action-btn" form="action-form" formaction="' . $action_page . '">' . $button_text . '</button>';
                    }
                    ?>
            </div>
